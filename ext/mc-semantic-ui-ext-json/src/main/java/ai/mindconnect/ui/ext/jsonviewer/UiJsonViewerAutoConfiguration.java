...
/**
 * Spring-Boot auto-configuration: registers {@link UiJsonViewerModule} as a
 * bean whenever Jackson is on the classpath. Spring Boot's
...
public class UiJsonViewerAutoConfiguration {

    @Bean
    public Module uiJsonViewerModule() {
        return new UiJsonViewerModule();
    }
}
